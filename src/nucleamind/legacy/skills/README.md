...
This directory contains built-in skills that extend NucleaMind's capabilities.
...
When skills reference large local documentation or logs, prefer the runtime's built-in
