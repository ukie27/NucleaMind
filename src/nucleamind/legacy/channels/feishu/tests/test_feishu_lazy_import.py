...
def test_feishu_module_import_does_not_import_lark_oapi():
    out = _run_import_probe(
        "import sys; import nucleamind.legacy.channels.feishu; print('lark_oapi' in sys.modules)"
    )
...
def test_lark_runtime_thread_import_clears_sdk_import_loop():
    out = _run_import_probe(
        ...
        "from nucleamind.legacy.channels.feishu.runtime import _load_lark_runtime\n"
