...
class TestSubagentHookStatus:
    ...
    async def test_after_iteration_updates_status(self):
        ...
        from nucleamind.legacy.agent.subagent import SubagentStatus, _SubagentHook
    ...
    async def test_after_iteration_no_status_is_noop(self):
        ...
        from nucleamind.legacy.agent.hook import AgentHookContext
        from nucleamind.legacy.agent.subagent import _SubagentHook
...
class TestRequestContext:
    ...
    def test_audit_reads_bound_session(self):
        ...
        with patch("nucleamind.legacy.agent.tools.self.logger.info") as info:
            with request_context(ctx):
