...
async def test_drain_injections_passes_limit_to_callback_when_supported():
    ...
    from nucleamind.legacy.agent.runner import _MAX_INJECTIONS_PER_TURN, AgentRunner
    from nucleamind.legacy.bus.events import InboundMessage
...
async def test_submitted_cron_turn_reports_pending_until_completed(tmp_path):
    ...
    from nucleamind.legacy.cron.session_turns import CRON_TRIGGER_META
...
async def test_pending_queue_preserves_overflow_for_next_injection_cycle(tmp_path):
    ...
    from nucleamind.legacy.agent.loop import AgentLoop
    from nucleamind.legacy.agent.runner import _MAX_INJECTIONS_PER_TURN
    from nucleamind.legacy.bus.events import InboundMessage
    from nucleamind.legacy.bus.queue import MessageBus
...
async def test_drain_injections_on_empty_final_response():
    ...
    from nucleamind.legacy.agent.runner import _MAX_EMPTY_RETRIES, AgentRunner
    from nucleamind.legacy.bus.events import InboundMessage
