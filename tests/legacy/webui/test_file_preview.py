...
from nucleamind.legacy.security.workspace_access import default_workspace_scope
from nucleamind.legacy.webui.file_preview import WebUIFilePreviewError, file_preview_payload
...
def test_restricted_preview_allows_media_file(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("nucleamind.legacy.webui.file_preview.get_media_dir", lambda: media)
