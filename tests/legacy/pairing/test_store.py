...
from nucleamind.legacy.pairing import __all__ as pairing_all
from nucleamind.legacy.pairing import store


def test_all_exports_are_importable():
    """Every name in __all__ must actually be importable from nucleamind.legacy.pairing."""
    import nucleamind.legacy.pairing as pkg
