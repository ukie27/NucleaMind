...
from nucleamind.legacy.agent.tools.loader import _SKIP_MODULES, ToolLoader
...
def test_web_tools_config_cls():
    from nucleamind.legacy.agent.tools.web import WebFetchTool, WebSearchTool, WebToolsConfig
...
def test_web_fetch_tool_create():
    from nucleamind.legacy.agent.tools.web import WebFetchTool
    mock_config = MagicMock()
    mock_config.web.enable = True
...
def test_image_gen_tool_config_cls():
    from nucleamind.legacy.agent.tools.image_generation import (
        ImageGenerationTool,
...
def test_my_tool_config_cls():
    from nucleamind.legacy.agent.tools.self import MyTool, MyToolConfig
