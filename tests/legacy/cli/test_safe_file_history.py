...
from nucleamind.legacy.cli.commands import SafeFileHistory as LegacySafeFileHistory
from nucleamind.legacy.cli.terminal import SafeFileHistory, _sanitize_surrogates
